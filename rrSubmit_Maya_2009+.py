...
def rrGetRR_Root():
        ...
        if ((sys.platform.lower() == "win32") or (sys.platform.lower() == "win64")):
            ...
            HCPath="/Users/kif/Documents/rr/server"
        else:
            HCPath="%RRLocationLx%"
        if HCPath[0]!="%":
            return HCPath
...
def initializePlugin(mobject):
    try:
        ...
        maya.mel.eval('menuItem -p $RRMenuCtrl -l "Submit scene - Bake Textures" -c "rrSubmit false false false false true";')
